...
def show_go_screen():
	...
	draw_text(screen, "Lucha contra los meteoritos y destruyelos", 27, WIDTH // 2, HEIGHT // 2)
	draw_text(screen, "Presiona una tecla para iniciar el combate!", 20, WIDTH // 2, HEIGHT * 3/4)
	pygame.display.flip()
	waiting = True
	while waiting:
		clock.tick(60)
